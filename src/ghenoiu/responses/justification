...
[merge these two. this one is pretty solid i presume]
...
Tafuri says "operative criticism designs past history in order to project it towards the future"

all were complicit in a mode of historical analysis that overtly or covertly pointed toward a present and future architecture